...
__declspec(dllimport) bool __stdcall ExtractOverlayW(wchar_t* szFileName, wchar_t* szExtactedFileName);
...
__declspec(dllimport) void* __stdcall DisassembleEx(HANDLE hProcess, LPVOID DisassmAddress);
...
// TitanEngine.Identifier.functions:
__declspec(dllimport) void __stdcall IdentifyInit();
__declspec(dllimport) int __stdcall IdentifyRegisterNewSignature(LPVOID SignatureHeaderPointer);
__declspec(dllimport) int __stdcall IdentifyFileEx(char* szFileName, LPVOID DetectedString, ULONG_PTR EntryOverrideVA);
__declspec(dllimport) int __stdcall IdentifyFile(char* szFileName, LPVOID DetectedString);
__declspec(dllimport) void* __stdcall IdentifyGetSignatureHeader(int SignatureId);
__declspec(dllimport) bool __stdcall IdentifyGetSignatureOrigine(int SignatureId, LPVOID SignatureAuthor, LPVOID SignatureAuthorWebSite);
...
__declspec(dllimport) bool __stdcall ImporterIsForewardedAPI(HANDLE hProcess, ULONG_PTR APIAddress);
