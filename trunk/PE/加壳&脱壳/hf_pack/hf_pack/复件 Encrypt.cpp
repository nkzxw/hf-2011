...
#pragma code_seg(".extcd")  // Lets put all functions in a separated code segmentr
...
void __stdcall AttachProc()
{
 ...
 //     
   ...
   //             pFunction = (PCHAR)dwKernel32 + pFunctions[Ordinal]; 
			...
			//		jmp eax
			//	}
			//	pAttachData->_GetProcAddress = (TGetProcAddress)(PULONG)pFunction;
   //             break;   
   //         }   
   //     }   
   // }   
    ...
    {   
        ...
        {   
            ...
            {   
                ...
                //   
                pFunction = (PCHAR)dwKernel32 + pFunctions[Ordinal];   
				//RelativeID = dwAddressOfNameOrdinals + i* 2;
				//pAttachData->_GetProcAddress = (TGetProcAddress)(dwKernel32 + dwAddressOfFunctions + RelativeID *4);
