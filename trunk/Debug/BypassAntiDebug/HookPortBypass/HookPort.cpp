...
{   
	...
	{   
		if (!MmIsAddressValid(cPtr))  
			continue;   
	
		ServiceTableAddress = *(PULONG)cPtr;   
		if (!MmIsAddressValid((PVOID)ServiceTableAddress)) 
			continue;   
...
/*__declspec(naked)*/ 
int	__stdcall  myNtGetContextThread(
	HANDLE	ThreadHandle, 
	PCONTEXT	pContext
	)
{
...
//////////////////////////////////////////////////////////////////////////
ULONG __stdcall MyKiFastCallEntryFilter(
	ULONG ServiceIndex, 
	ULONG OriginalServiceRoutine, 
	ULONG ServiceTable
	) 
{ 
...
void IATHookWin32(
	...
	char *ModuleNameDst, 
	char *pFunName, 
	ULONG pfNewFunAddress, 
	ULONG &pfnOriAddressLocation, 
	ULONG &pfnOriAddress
	)
{
