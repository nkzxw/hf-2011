...
//
 ...
 BOOLEAN NtfsProtectSystemFiles;
 BOOLEAN NtfsProtectSystemAttributes;
...
//
 ...
 ULONG NtfsCleanCheckpoints;
 ULONG NtfsPostRequests;
...
//
 ...
 UNICODE_STRING NtfsEmptyString;

//
//  The following file references are used to identify system files.
//

 FILE_REFERENCE MftFileReference;
 FILE_REFERENCE Mft2FileReference;
 FILE_REFERENCE LogFileReference;
 FILE_REFERENCE VolumeFileReference;
 FILE_REFERENCE RootIndexFileReference;
 FILE_REFERENCE BitmapFileReference;
 FILE_REFERENCE FirstUserFileReference;
 FILE_REFERENCE BootFileReference;
...
//
 ...
 UCHAR BaadSignature[4];
 UCHAR IndexSignature[4];
 UCHAR FileSignature[4];
 UCHAR HoleSignature[4];
 UCHAR ChkdskSignature[4];

//
//  Large Reserved Buffer Context
//

 ULONG NtfsReservedInUse;
 PVOID NtfsReserved1;
 PVOID NtfsReserved2;
 ULONG NtfsReserved2Count;
 PVOID NtfsReserved3;
 PVOID NtfsReserved1Thread;
 PVOID NtfsReserved2Thread;
 PVOID NtfsReserved3Thread;
 PFCB NtfsReserved12Fcb;
 PFCB NtfsReserved3Fcb;
 PVOID NtfsReservedBufferThread;
 BOOLEAN NtfsBufferAllocationFailure;
 FAST_MUTEX NtfsReservedBufferMutex;
 ERESOURCE NtfsReservedBufferResource;
 LARGE_INTEGER NtfsShortDelay;
...
//
 ...
 LONG NtfsDebugTraceLevel;
 LONG NtfsDebugTraceIndent;
 LONG NtfsFailCheck;
...
//
 ...
 ULONG NtfsFsdEntryCount;
 ULONG NtfsFspEntryCount;
 ULONG NtfsIoCallDriverCount;
