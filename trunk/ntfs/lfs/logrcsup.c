...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsWriteLogRecordIntoLogPage:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Lfcb                      -> %08lx\n", Lfcb );
    LfsDebugTrace(  0, Dbg, "Lch                       -> %08lx\n", Lch );
    LfsDebugTrace(  0, Dbg, "Number of Write Entries   -> %08lx\n", NumberOfWriteEntries );
    LfsDebugTrace(  0, Dbg, "Write Entries             -> %08lx\n", WriteEntries );
    LfsDebugTrace(  0, Dbg, "Record Type               -> %08lx\n", RecordType );
    LfsDebugTrace(  0, Dbg, "Transaction Id            -> %08lx\n", TransactionId );
    LfsDebugTrace(  0, Dbg, "ClientUndoNextLsn (Low)   -> %08lx\n", ClientUndoNextLsn.LowPart );
    LfsDebugTrace(  0, Dbg, "ClientUndoNextLsn (High)  -> %08lx\n", ClientUndoNextLsn.HighPart );
    LfsDebugTrace(  0, Dbg, "ClientPreviousLsn (Low)   -> %08lx\n", ClientPreviousLsn.LowPart );
    LfsDebugTrace(  0, Dbg, "ClientPreviousLsn (High)  -> %08lx\n", ClientPreviousLsn.HighPart );
    LfsDebugTrace(  0, Dbg, "UndoRequirement           -> %08lx\n", UndoRequirement );
    LfsDebugTrace(  0, Dbg, "ForceToDisk               -> %04x\n", ForceToDisk );
    ...
    RecordHeader = LfsAdd2Ptr( ThisLbcb->PageHeader,
    ...
    *Lsn = NextLsn;
    ...
    LfsDebugTrace( -1, Dbg, "LfsWriteLogRecordIntoLogPage:  Exit\n", 0 );
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsPrepareLfcbForLogRecord:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Lfcb              -> %08lx\n", Lfcb );
    LfsDebugTrace(  0, Dbg, "RemainingLogBytes -> %08lx\n", RemainingLogBytes );
    ...
    LfsDebugTrace( -1, Dbg, "LfsPrepareLfcbForLogRecord:  Exit\n", 0 );
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsTransferLogBytes:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Lbcb                      -> %08lx\n", Lbcb );
    LfsDebugTrace(  0, Dbg, "ThisWriteEntry            -> %08lx\n", *ThisWriteEntry );
    LfsDebugTrace(  0, Dbg, "CurrentBuffer             -> %08lx\n", *CurrentBuffer );
    LfsDebugTrace(  0, Dbg, "CurrentByteCount          -> %08lx\n", *CurrentByteCount );
    LfsDebugTrace(  0, Dbg, "RemainingPageBytes        -> %08lx\n", *RemainingPageBytes );
    LfsDebugTrace(  0, Dbg, "RemainingLogBytes         -> %08lx\n", *RemainingLogBytes );
    ...
    CurrentLogPagePosition = LfsAdd2Ptr( Lbcb->PageHeader, (ULONG)Lbcb->BufferOffset, PCHAR );
    ...
    *RemainingPageBytes -= (TransferBytes + ThisPadBytes);
    ...
    LfsDebugTrace( -1, Dbg, "LfsTransferLogBytes:  Exit\n", 0 );
