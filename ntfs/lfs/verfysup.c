...

{
    *CurrentPageBytes = 0;
    ...
    LfsDebugTrace( +1, Dbg, "LfsCurrentAvailSpace:  Entered\n", 0 );
    ...
    *CurrentAvailSpace = Lfcb->CurrentAvailable;
    ...
    LfsDebugTrace( +1, Dbg, "LfsCurrentAvailSpace:  Exit\n", 0 );
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsVerifyLogSpaceAvail:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Lfcb              -> %08x\n", Lfcb );
    ...
    if (LfsRaiseFull) {
        ...
        LfsRaiseFull = FALSE;
        LfsDebugTrace( -1, Dbg, "LfsVerifyLogSpaceAvail:  About to raise\n", 0 );
    ...
    LfsDebugTrace( -1, Dbg, "LfsVerifyLogSpaceAvail:  Exit\n", 0 );
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsFindCurrentAvail:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Lfcb              -> %08x\n", Lfcb );
    ...
    LfsDebugTrace( -1, Dbg, "LfsFindCurrentAvail:  Exit\n", 0 );
