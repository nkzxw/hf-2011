...
#else
			pSubMenu->TrackPopupMenu(TPM_LEFTALIGN|TPM_RIGHTBUTTON, pos.x, pos.y, pTargetWnd, NULL);
#endif
...
BOOL CSystemTray::RemoveTaskbarIcon(CWnd *pWnd)
{
	...
	{
		if(!m_wndInvisible.CreateEx(0, pstrOwnerClass, _T(""), WS_POPUP, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT,
