...
//#pragma alloc_text(PAGE, JeTusCreate)
//#pragma alloc_text(PAGE, JeTusRead)
//#pragma alloc_text(PAGE, JeTusWrite)
//#pragma alloc_text(PAGE, JeTusSetInformation)
//#pragma alloc_text(PAGE, JeTusQueryInformation)
...

{
    ...
    DriverObject->MajorFunction[IRP_MJ_CREATE]				= JeTusCreate;			//SfCreate;
    DriverObject->MajorFunction[IRP_MJ_CREATE_NAMED_PIPE]	= JeTusCreate;			//SfCreate;
    DriverObject->MajorFunction[IRP_MJ_CREATE_MAILSLOT]		= JeTusCreate;			//SfCreate;
    
    DriverObject->MajorFunction[IRP_MJ_FILE_SYSTEM_CONTROL] = SfFsControl;
    DriverObject->MajorFunction[IRP_MJ_CLEANUP] = JeTusCleanup;
    DriverObject->MajorFunction[IRP_MJ_CLOSE]	= JeTusClose;

	DriverObject->MajorFunction[IRP_MJ_READ]	= JeTusRead;
	DriverObject->MajorFunction[IRP_MJ_WRITE]	= JeTusWrite;
	DriverObject->MajorFunction[IRP_MJ_SET_INFORMATION]		= JeTusSetInformation;
	DriverObject->MajorFunction[IRP_MJ_QUERY_INFORMATION]	= JeTusQueryInformation;
