...
BOOL CColorButton::Attach(const UINT nID, CWnd* pParent, const COLORREF BGColor, const COLORREF FGColor, const COLORREF DisabledColor,const COLORREF DisabledbgColor, const UINT nBevel)
{
...
void CColorButton::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
	...
	if (state & ODS_FOCUS) {
    	...
    	//COLORREF disabledColor = bg ^ 0xFFFFFF; // contrasting color
  		DrawFilledRect(pDC, btnRect, GetDisabledbgColor()); 
    	DrawFrame(pDC, btnRect, -1);
