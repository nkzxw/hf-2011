...
public:
	...
	BOOL Attach(const UINT nID, CWnd* pParent, 
		...
		const COLORREF DisabledbgColor = RGB(0, 0, 0),// dark gray disabled text
		const UINT nBevel = 2	);
...
protected:
    ...
    COLORREF GetDisabledbgColor() { return m_disabledbg; }
	UINT GetBevel() { return m_bevel; }

private:
	COLORREF m_fg, m_bg, m_disabled,m_disabledbg;
	UINT m_bevel;
